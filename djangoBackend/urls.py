...
from backend.views.bids import get_bidding, get_all_biddings,insert_bid,delete_bid
from backend.views.searches import get_searches, get_search, insert_search, delete_search
from backend.views.auctions import get_auction, get_auctions,delete_auction,show_hide_auction,highlight_auction,bidding_on_auction
...
urlpatterns = [
    ...
    path('bidding_on_auction/<int:id>/<str:state>', bidding_on_auction, name='bidding_on_auction'),
